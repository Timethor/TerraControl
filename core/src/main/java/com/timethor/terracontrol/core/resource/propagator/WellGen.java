...
public class WellGen extends Resource {
    ...
    public void load(List<String> args) throws InvalidConfigException {
        ...
        chance = readRarity(args.get(4));
        minAltitude = readInt(args.get(5), TerraControl.worldDepth, TerraControl.worldHeight);
        maxAltitude = readInt(args.get(6), minAltitude + 1, TerraControl.worldHeight);
    ...
    public String makeString() {
        ...
        output += frequency + "," + chance + "," + minAltitude + "," + maxAltitude + this.makeMaterial(sourceBlocks) + ")";
        return output;
    }
}