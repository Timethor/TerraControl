...
public enum MaterialCatalog {
     ...
     */
    private MaterialCatalog(int id, boolean solid) {
        this.id = id;
        this.solid = solid;
    }
     ...
     * @param id Id of the material.
     */
    private MaterialCatalog(int id) {
        this.id = id;
        this.solid = true;
    }
    ...
    private static MaterialCatalog[] lookupID;
    private static Map<String, MaterialCatalog> lookupName;

    static {
        lookupID = new MaterialCatalog[256];
        lookupName = new HashMap<String, MaterialCatalog>();
     ...
     * @return
     */
    public static MaterialCatalog getMaterial(String name) {
     ...
     * @return
     */
    public static MaterialCatalog getMaterial(int id) {
