...
public class BO3Config extends ConfigFile {
    ...
    protected void readConfigSettings() {
        ...
        settingsMode = readSettings(TerrainControlCatalog.SettingsMode);
    ...
    private void readResources() {
        ...
        for (Map.Entry<String, String> entry : this.settingsCache.entrySet()) {
            ...
            if (start != -1 && end != -1) {
                ...
                ConfigFunction<BO3Config> res = TerraControl.getConfigFunctionsManager().getConfigFunction(functionName, this, this.name + " on line " + entry.getValue(), Arrays.asList(props));
