...
public class BlockHelper {
    ...
    /**
     * Returns the rotated data value of the block. Rotates the block in
     * the direction: North -> west - > south - > east
     * <p/>
     * @param type The Block Type
     * @param data The Data value of the block
     * <p/>
     * @return The rotated data value of the Block
     */
    @SuppressWarnings({"PointlessBitwiseExpression", "incomplete-switch"})
    public static int rotateData(int type, int data) {
        MaterialCatalog mat = MaterialCatalog.getMaterial(type);
        if (mat == MaterialCatalog.UNKNOWN_BLOCK) {
            return data;
        }
        ...
        switch (mat) {
            ...
            case LOG:
                switch (data / 4) {
                    case 1:
                        //>>	 East/West-->North/South horizontal log
                        return data + 4;
                    case 2:
                        //>>	North/South-->East/West horizontal log
                        return data - 4;
