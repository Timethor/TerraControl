 ...
 * different results
 */
public class B_PerlinNoiseGenerator extends B_NoiseGenerator {
    ...
    private static final B_PerlinNoiseGenerator instance = new B_PerlinNoiseGenerator();

    /**
     *
     */
    protected B_PerlinNoiseGenerator() {
     ...
     */
    public B_PerlinNoiseGenerator(long seed) {
     ...
     */
    public B_PerlinNoiseGenerator(Random rand) {
     ...
     * @return Singleton
     */
    public static B_PerlinNoiseGenerator getInstance() {
        return instance;
    }
