 ...
 */
public abstract class B_OctaveGenerator {

    /**
	 */
    protected final B_NoiseGenerator[] octaves;
    /**
	 */
     ...
     * @param octaves
     */
    protected B_OctaveGenerator(B_NoiseGenerator[] octaves) {
     ...
     */
    public B_NoiseGenerator[] getOctaves() {
