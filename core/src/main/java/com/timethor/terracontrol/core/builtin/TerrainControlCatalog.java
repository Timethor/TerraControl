 ...
 * @author Timethor
 */
public enum TerrainControlCatalog implements TerraSetting {
    // Files
    ...
    private TerrainControlCatalog(int i) {
        this.iValue = i;
        this.returnType = SettingsType.Int;
    }

    private TerrainControlCatalog(double d) {
        this.dValue = d;
        this.returnType = SettingsType.Double;
    }

    private TerrainControlCatalog(float f) {
        this.fValue = f;
        this.returnType = SettingsType.Float;
    }

    private TerrainControlCatalog(long l) {
        this.lValue = l;
        this.returnType = SettingsType.Long;
    }

    private TerrainControlCatalog(String s) {
        this.sValue = s;
        this.returnType = SettingsType.String;
    }

    private TerrainControlCatalog(String s, SettingsType type) {
    ...
    private TerrainControlCatalog(Enum<?> e) {
        this.eValue = e;
        this.returnType = SettingsType.Enum;

    }

    private TerrainControlCatalog(boolean b) {
        this.bValue = b;
