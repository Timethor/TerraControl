...
public abstract class ConfigFunction<T> {
    ...
    public static <T> ConfigFunction<?> create(T holder, Class<? extends ConfigFunction<T>> clazz, Object... args) {
        ...
        try {
            ...
            TerraControl.log(Level.WARNING, "Invalid default config function! Please report! " + clazz.getName() + ": " + e.getMessage());
    ...
    /**
     * Returns true if this ConfigFunction has a correct syntax. Returns
     * false if the read method hasn't been called yet, or if the function
     ...
     * shouldn't use this, as the read method will automatically set it to
     * the correct value.
     * <p/>
