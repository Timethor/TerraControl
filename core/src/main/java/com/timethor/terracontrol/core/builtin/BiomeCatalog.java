...
public enum BiomeCatalog {
    ...
    private static BiomeCatalog[] lookupID;

    private BiomeCatalog(int i, String name) {
        this.Id = i;
        this.Name = name;
    }

    static {
        lookupID = new BiomeCatalog[BiomeCatalog.values().length + 1];
        for (BiomeCatalog biome : BiomeCatalog.values()) {
     ...
     * @return
     */
    public static BiomeCatalog getBiome(int id) {
