...
/**
 * Contains a lot of alternative mob names. The implementation should support this names, along with the other names that are available on the current platform.
 */
public enum MobCatalog {
    ...
    private MobCatalog(String internalMinecraftName, String... aliases) {
    ...
    static {
        for (MobCatalog alt : MobCatalog.values()) {
     ...
     *
     * @param internalMinecraftName The internal Minecraft mob id, for
     *                              example Ozelot
    ...
    /**
     * Returns the internal name of the mob. If it can't be found, it
     * returns
     * the alias.
     *
