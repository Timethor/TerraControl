 ...
 * TerraControl.registerEventHander(..). If you want to use the onStart(),
 * make sure that it is registered before TerraControl is started.
 */
public abstract class EventHandler {
     ...
     * event. UseWorld and UseBiome won't fire this event, but BO2 and BO3
     * will.
     * <p/>
     * This event should NOT be used to modify data in the object or the
     * world. However, you can cancel the event by returning false.
     *
     ...
     *         does nothing.
     */
    public boolean canCustomObjectSpawn(CustomObject object, TerraWorld world, int x, int y, int z, boolean isCancelled) {
        return true;
    }
     ...
     * @param villageInChunk Whether there is a village in the current
     *                       chunk.
     * @param chunkX         The x coordinate of the chunk the resource
     *                       will spawn in.
     ...
     *         does nothing.
     */
    public boolean onResourceProcess(Resource resource, TerraWorld world, Random random, boolean villageInChunk, int chunkX, int chunkZ, boolean isCancelled) {
        return true;
    }

    /**
     * Called whenever Terrain Control starts to populate a chunk. Cannot
     * be canceled.
     *
     ...
     * @param villageInChunk Whether there is a village in the current
     *                       chunk.
     * @param chunkX         The x coordinate of the chunk that is being
     *                       populated.
     * @param chunkZ         The z coordinate of the chunk that is being
     *                       populated.
     */
    public void onPopulateStart(TerraWorld world, Random random, boolean villageInChunk, int chunkX, int chunkZ) {
    }

    /**
     * Called whenever Terrain Control is done populating a chunk. Cannot
     * be canceled.
     *
     * @param world          The world where the population occurred.
     * @param random         The random generator.
     ...
     *                       populated.
     */
    public void onPopulateEnd(TerraWorld world, Random random, boolean villageInChunk, int chunkX, int chunkZ) {
    }
}
