...
/**
 * UseBiome is a keyword that spawns the objects in the
 * BiomeConfig/BiomeObjects
 * setting.
 */
public class UseBiome implements CustomObject {
     ...
     * @return
     */
    public ArrayList<CustomObject> getPossibleObjectsAt(TerraWorld world, int x, int z) {
