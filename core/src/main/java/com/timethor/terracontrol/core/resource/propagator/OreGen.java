...
public class OreGen extends Resource {
    ...
    public void load(List<String> args) throws InvalidConfigException {
        ...
        minAltitude = readInt(args.get(4), TerraControl.worldDepth, TerraControl.worldHeight);
        maxAltitude = readInt(args.get(5), minAltitude + 1, TerraControl.worldHeight);
    ...
    public String makeString() {
        return "Ore(" + makeMaterial(blockId, blockData) + "," + maxSize + "," + frequency + "," + chance + "," + minAltitude + "," + maxAltitude + makeMaterial(sourceBlocks) + ")";
    }
}
