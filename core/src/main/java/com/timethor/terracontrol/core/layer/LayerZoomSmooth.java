 ...
 * @author Timethor
 */
public class LayerZoomSmooth extends Layer {
     ...
     * @param paramGenLayer
     */
    public LayerZoomSmooth(long paramLong, Layer paramGenLayer) {
        super(paramLong);
    ...
    public static Layer a(long paramLong, Layer paramGenLayer, int paramInt) {
        ...
        for (int i = 0; i < paramInt; i++) {
            localObject = new LayerZoomSmooth(paramLong + i, localObject);
        }
        return localObject;
    }
}