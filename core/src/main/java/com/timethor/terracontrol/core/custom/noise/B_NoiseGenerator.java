 ...
 */
public abstract class B_NoiseGenerator {
    ...
    /**
     * Computes and returns the 1D noise for the given coordinate in 1D
     * space
     *
    ...
    /**
     * Computes and returns the 2D noise for the given coordinates in 2D
     * space
     *
     * @param x X coordinate
    ...
    /**
     * Computes and returns the 3D noise for the given coordinates in 3D
     * space
     *
     * @param x X coordinate
     * @param y Y coordinate
