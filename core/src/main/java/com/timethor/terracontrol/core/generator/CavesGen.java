...
public class CavesGen extends TerrainGenBase {
    ...
    public CavesGen(WorldConfig wrk, TerraWorld world) {
        super(world);
    ...
    protected void a(long paramLong, int paramInt1, int paramInt2, byte[] paramArrayOfByte, double paramDouble1, double paramDouble2, double paramDouble3, float paramFloat1, float paramFloat2, float paramFloat3, int paramInt3, int paramInt4, double paramDouble4) {
        ...
        for (; paramInt3 < paramInt4; paramInt3++) {
            ...
            int m = MathHelper.floor_int(paramDouble1 - d3) - paramInt1 * 16 - 1;
            int n = MathHelper.floor_int(paramDouble1 + d3) - paramInt1 * 16 + 1;

            int i1 = MathHelper.floor_int(paramDouble2 - d4) - 1;
            int i2 = MathHelper.floor_int(paramDouble2 + d4) + 1;

            int i3 = MathHelper.floor_int(paramDouble3 - d3) - paramInt2 * 16 - 1;
            int i4 = MathHelper.floor_int(paramDouble3 + d3) - paramInt2 * 16 + 1;
                ...
                for (int i7 = i3; (i5 == 0) && (i7 < i4); i7++) {
                    for (int i8 = i2 + 1; (i5 == 0) && (i8 >= i1 - 1); i8--) {
                        ...
                        if (i8 < this.worldSettings.WorldHeight) {
                            if ((paramArrayOfByte[i9] == MaterialCatalog.WATER.id) || (paramArrayOfByte[i9] == MaterialCatalog.STATIONARY_WATER.id)) {
                                i5 = 1;
                            }
                    ...
                    if (d9 * d9 + d10 * d10 < 1.0D) {
                        for (int i12 = i2 - 1; i12 >= i1; i12--) {
                            ...
                            if ((d11 > -0.7D) && (d9 * d9 + d11 * d11 + d10 * d10 < 1.0D)) {
                                ...
                                if (i13 == MaterialCatalog.GRASS.id) {
                                    i11 = 1;
                                }
                                if ((i13 == MaterialCatalog.STONE.id) || (i13 == MaterialCatalog.DIRT.id) || (i13 == MaterialCatalog.GRASS.id)) {
                                    if (i12 < 10) {
                                        paramArrayOfByte[i10] = (byte) MaterialCatalog.LAVA.id;
                                    } else {
                                        paramArrayOfByte[i10] = 0;
                                        if ((i11 != 0) && (paramArrayOfByte[(i10 - 1)] == MaterialCatalog.DIRT.id)) {
                                            paramArrayOfByte[(i10 - 1)] = (byte) MaterialCatalog.GRASS.id;
                                        }
                                    }
                                }
                            }
