...
import com.timethor.terracontrol.core.util.MetricsHelper;
import com.timethor.terraincontrol.forge.TerraPlugin;
import com.timethor.terracontrol.forge.util.Metrics.Graph;
...
public class ForgeMetricsHelper extends MetricsHelper {
    ...
    public ForgeMetricsHelper(TerraPlugin plugin) {
        this.plugin = plugin;
    ...
    private void startMetrics() {
        // Get enabled worlds
        Iterable<TerraWorld> loadedWorlds;
