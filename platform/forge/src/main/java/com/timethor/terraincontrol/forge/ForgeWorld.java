...
import com.timethor.terracontrol.forge.structuregens.RareBuildingGen;
import com.timethor.terracontrol.forge.structuregens.StrongholdGen;
import com.timethor.terracontrol.forge.structuregens.VillageGen;
import com.timethor.terracontrol.forge.structuregens.NetherFortressGen;
import com.timethor.terracontrol.forge.structuregens.MineshaftGen;

import com.timethor.terracontrol.forge.util.NBTHelper;
 ...
 *
 */
public class ForgeWorld implements TerraWorld {
    ...
    public int getHighestBlockYAt(int x, int z) {
        ...
        while (chunk.getBlockID(x, y, z) != MaterialCatalog.AIR.id && y <= worldHeight) {
    ...
    public void attachMetadata(int x, int y, int z, Tag tag) {
        ...
        if (tileEntity != null) {
            ...
            TerraControl.log(Level.INFO, "Skipping tile entity with id " + nmsTag.getString("id") + ", cannot be placed at " + x + "," + y + "," + z + " on id " + world.getBlockId(x, y, z));
        }
    }
