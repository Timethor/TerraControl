...
public class ChunkProvider implements IChunkProvider {
    ...
    private TerraChunkProvider generator;
    ...
    public ChunkProvider(ForgeWorld _world) {
        ...
        this.generator = new TerraChunkProvider(this.world.getSettings(), this.world);
    ...
    public String makeString() {
        return TerraCatalog.ChannelName.stringValue() + "LevelSource";
    }
