                ...
                for (int i = 0; i < regionFiles.length; i++) {
                    ...
                    for (int x = 0; x < 32; x++) {
                        for (int z = 0; z < 32; z++) {
                            ...
                            try (DataInputStream localDataInputStream = file.a(x, z)) {
                                localNBTTagCompound1 = NBTCompressedStreamTools.a((DataInput) localDataInputStream);
                            }
                            ...
                            if (chunkTag.hasKey("Biomes")) {
                                ...
                                if (needSave) {
                                    ...
                                    chunksRewritten++;
                                    try (DataOutputStream localDataOutputStream = file.b(x, z)) {
