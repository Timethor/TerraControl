...
import com.timethor.terracontrol.core.resource.propagator.SaplingType;
...
public class TerraListener implements Listener {
    ...
    /**
     */
    private TerraPlugin tcPlugin;
    /**
     */
    private TerraSender tcSender;

    public TerraListener(TerraPlugin plugin) {
        this.tcPlugin = plugin;
        this.tcSender = new TerraSender(plugin);
    ...
    public void onPlayerRegisterChannel(PlayerRegisterChannelEvent event) {
        ...
        if (event.getChannel().equals(TerraCatalog.ChannelName.stringValue())) {
    ...
    public void onPlayerChangedWorld(PlayerChangedWorldEvent event) {
        ...
        if (player.getListeningPluginChannels().contains(TerraCatalog.ChannelName.stringValue())) {
